...
| :--- | :--- | :--- | :--- | :--- |
| **Alexandre** | Scrum Master | *(à définir)* | *(à définir)* | *(à définir)* |
| **Anass** | Product Owner | *(à définir)* | *(à définir)* | *(à définir)* |
| **Camille** | Technicien | *(à définir)* | *(à définir)* | *(à définir)* |
| **Jeremy** | Technicien | *(à définir)* | *(à définir)* | *(à définir)* |
