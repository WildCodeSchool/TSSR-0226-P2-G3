...
- [Utilisation : Comment exécuter le script ?](#utilisation--comment-exécuter-le-script-)
...
**Q : Pourquoi mon script `principal_bash.sh` se ferme-t-il brusquement après une action ?**
